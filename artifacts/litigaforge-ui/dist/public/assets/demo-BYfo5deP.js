...
`;function H(){const[s,i]=r.useState(-1),[n,g]=r.useState(0),[b,x]=r.useState(!1),[j,u]=r.useState(!1),[I,k]=r.useState([]),[C,P]=r.useState(60),o=r.useRef(null),c=r.useRef(null),m=r.useRef(0),y=r.useRef([]);r.useEffect(()=>{const a=document.createElement("style");return a.id="demo-css",a.textContent=D,document.head.appendChild(a),()=>{a.remove()}},[]);const N=r.useRef(null);N.current||(N.current=Array.from({length:110},(a,t)=>{const d=Math.random()*1.8+.4;return e.jsx("div",{className:"d-star",style:{width:d,height:d,top:`${Math.random()*100}%`,left:`${Math.random()*100}%`,opacity:Math.random()*.5+.05,animationDelay:`${Math.random()*5}s`,animationDuration:`${3+Math.random()*4}s`}},t)}));const z=r.useRef(!1),w=r.useCallback(a=>{if(i(a),a===3&&!z.current){z.current=!0;let t=60,d=94,f=1200,h=null;const F=M=>{h||(h=M);const R=Math.min((M-h)/f,1),L=1-Math.pow(1-R,3);P(Math.round(t+(d-t)*L)),R<1&&requestAnimationFrame(F)};requestAnimationFrame(F)}a===2&&(y.current.forEach(clearTimeout),k([]),y.current=[0,1,2].map(t=>setTimeout(()=>k(d=>[...d,t]),(t+1)*800)))},[]),A=r.useCallback(a=>{c.current||(c.current=a);const t=Math.min((a-c.current+m.current)/1e3,v),d=t/v*100;g(d);const f=B(t);if(i(h=>(h!==f&&w(f),f)),t>=v){x(!1),u(!0),g(100);return}o.current=requestAnimationFrame(A)},[w]),p=r.useCallback(()=>{x(!0),u(!1),c.current=null,o.current=requestAnimationFrame(A)},[A]),T=r.useCallback(()=>{const a=performance.now(),t=c.current?a-c.current+m.current:m.current;m.current=t,c.current=null,o.current&&cancelAnimationFrame(o.current),x(!1)},[]),S=r.useCallback(()=>{o.current&&cancelAnimationFrame(o.current),m.current=0,c.current=null,z.current=!1,y.current.forEach(clearTimeout),g(0),i(-1),k([]),P(60),u(!1),setTimeout(()=>{i(0),p()},80)},[p]),E=r.useCallback(a=>{o.current&&cancelAnimationFrame(o.current),x(!1),u(!1);const t=G(a);m.current=t*1e3,c.current=null,g(t/v*100),w(a)},[w]),$=r.useCallback(()=>{if(j){S();return}b?T():p()},[j,b,T,p,S]);r.useEffect(()=>{const a=setTimeout(()=>{i(0)},400),t=setTimeout(()=>{p()},600);return()=>{clearTimeout(a),clearTimeout(t)}},[p]),r.useEffect(()=>()=>{o.current&&cancelAnimationFrame(o.current),y.current.forEach(clearTimeout)},[]);const Y=j?"Replay Demo":b?"Pause":"Resume";return e.jsxs("div",{id:"demo-root",children:[e.jsx("div",{id:"demo-stars",children:N.current}),e.jsx("div",{id:"demo-spotlight"}),e.jsx("div",{id:"demo-progress",style:{width:`${n}%`}}),e.jsx("button",{id:"demo-exit",onClick:()=>window.history.back(),children:"← Back"}),e.jsxs("section",{className:`d-scene${s===0?" d-active":""}`,children:[e.jsx("div",{className:"d-s1-item",children:e.jsxs("div",{className:"d-badge",children:[e.jsx("span",{className:"d-badge-dot"}),"Legal AI · Telangana & AP"]})}),e.jsxs("h1",{className:"d-h1 d-s1-item",children:[e.jsx("span",{className:"l1",children:"Legal Intelligence"}),e.jsx("span",{className:"l2",children:"Built for Telangana & AP"})]}),e.jsxs("p",{className:"d-sub d-s1-item",children:["Post your case. Get ",e.jsx("strong",{children:"AI-matched"})," with a verified advocate in minutes.",e.jsx("br",{}),"Local expertise. Faster legal help. Built for your courts."]}),e.jsxs("div",{className:"d-btns d-s1-item",children:[e.jsx("button",{className:"d-btn-p",children:"Get Started Free"}),e.jsx("button",{className:"d-btn-o",children:"▶  Watch 60-sec Demo"})]}),e.jsxs("div",{className:"d-stats d-s1-item",children:[e.jsxs("div",{className:"d-stat",children:[e.jsx("span",{className:"n",children:"16"})," Gov APIs"]}),e.jsxs("div",{className:"d-stat",children:[e.jsx("span",{className:"n",children:"3"})," AI Models"]}),e.jsxs("div",{className:"d-stat",children:[e.jsx("span",{className:"n",children:"100+"})," Advocates"]})]})]}),e.jsxs("section",{className:`d-scene${s===1?" d-active":""}`,children:[e.jsx("div",{className:"d-head",children:e.jsx("h2",{className:"d-h2",children:"Trusted from day one"})}),e.jsx("p",{className:"d-trust-sub",children:"Everything you need to choose your advocate with confidence."}),e.jsx("div",{className:"d-trust-grid",children:[["⭐",e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"4.9"})," avg. rating"]})],["👥",e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"2,400+"})," users helped"]})],["✅","Verified advocates only"],["🆓","Free to start"],["🔒","Anonymous posting"],["⚡","Matched in < 2 min"]].map(([a,t],d)=>e.jsxs("div",{className:"d-chip",children:[e.jsx("span",{style:{fontSize:"1.1rem"},children:a}),e.jsx("span",{children:t})]},d))}),e.jsxs("p",{className:"d-tagline",children:[e.jsx("strong",{children:"Post your case"})," · ",e.jsx("strong",{children:"Get matched in minutes"})," · ",e.jsx("strong",{children:"Choose with confidence"})]})]}),e.jsxs("section",{className:`d-scene${s===2?" d-active":""}`,children:[e.jsx("h2",{className:"d-flow-h",children:"How LitigaForge works"}),e.jsx("p",{className:"d-flow-sub",children:"Three steps from your problem to the right advocate."}),e.jsx("div",{className:"d-steps",children:[{icon:"🗂️",label:"Post Your Case",desc:"Describe your issue in seconds",card:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"d-sc-label",children:"Case details"}),e.jsxs("div",{className:"d-sc-row",children:[e.jsx("div",{className:"d-sc-dot"}),"Property dispute · Hyderabad"]}),e.jsxs("div",{className:"d-sc-row",children:[e.jsx("div",{className:"d-sc-dot"}),"Telugu · English"]}),e.jsxs("div",{children:[e.jsx("span",{className:"d-sc-tag",children:"Civil"}),e.jsx("span",{className:"d-sc-tag",children:"₹5k–₹20k"})]})]})},{icon:"🤖",label:"AI Analyzes",desc:"Multi-model AI scores every advocate",card:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"d-sc-label",children:"AI Processing"}),e.jsx("div",{className:"d-ai-pulse",children:[0,1,2,3,4].map(a=>e.jsx("div",{className:"d-ai-bar"},a))}),e.jsx("div",{style:{marginTop:".4rem",fontSize:".67rem",color:"#60a5fa",textAlign:"center"},children:"Scoring 100+ advocates…"})]})},{icon:"⚖️",label:"Get Matched",desc:"Review scored proposals, choose yours",card:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"d-sc-label",children:"Your matches"}),e.jsxs("div",{className:"d-sc-row",children:[e.jsx("div",{className:"d-sc-dot",style:{background:"#10b981"}}),"Adv. Priya Sharma · 94%"]}),e.jsxs("div",{className:"d-sc-row",children:[e.jsx("div",{className:"d-sc-dot",style:{background:"#60a5fa"}}),"Adv. Ravi Kumar · 87%"]}),e.jsxs("div",{className:"d-sc-row",children:[e.jsx("div",{className:"d-sc-dot",style:{background:"#818cf8"}}),"Adv. Anita Rao · 81%"]})]})}].map((a,t)=>e.jsxs("div",{className:`d-step${I.includes(t)?" d-lit":""}`,children:[t<2&&e.jsx("div",{className:"d-connector"}),e.jsxs("div",{className:"d-ico-wrap",children:[a.icon,e.jsx("span",{className:"d-step-num",children:t+1})]}),e.jsx("div",{className:"d-step-label",children:a.label}),e.jsx("div",{className:"d-step-desc",children:a.desc}),e.jsx("div",{className:"d-step-card",children:a.card})]},t))})]}),e.jsxs("section",{className:`d-scene${s===3?" d-active":""}`,children:[e.jsxs("h2",{className:"d-match-h",children:["Your top match — ",e.jsxs("span",{style:{color:"#60a5fa"},children:[C,"% fit"]})]}),e.jsx("p",{className:"d-match-sub",children:"AI picked the advocate who best fits your case, location & language."}),e.jsx("div",{className:"d-card-wrap",children:e.jsxs("div",{className:"d-card",children:[e.jsxs("div",{className:"d-mc-top",children:[e.jsx("div",{className:"d-mc-av",children:"PS"}),e.jsxs("div",{className:"d-mc-info",children:[e.jsxs("div",{className:"d-mc-name",children:["Adv. Priya Sharma",e.jsx("div",{className:"d-mc-badge",children:e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("polyline",{points:"2,6 5,9 10,3",stroke:"#fff",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),e.jsx("div",{className:"d-mc-spec",children:"Criminal Law · Hyderabad  ·  12 yrs exp"})]}),e.jsxs("div",{className:"d-mc-score-wrap",children:[e.jsxs("div",{className:"d-mc-score",children:[C,"%"]}),e.jsx("div",{className:"d-mc-score-lbl",children:"Match"})]})]}),e.jsxs("div",{className:"d-row",children:[e.jsx("span",{className:"d-tag",children:"Criminal Law"}),e.jsx("span",{className:"d-tag",children:"IPC 302–307"}),e.jsx("span",{className:"d-tag g",children:"Available Today"})]}),e.jsxs("div",{className:"d-row",style:{marginBottom:".7rem"},children:[e.jsx("span",{className:"d-tag a",children:"Telugu"}),e.jsx("span",{className:"d-tag a",children:"Hindi"}),e.jsx("span",{className:"d-tag a",children:"English"})]}),e.jsxs("div",{className:"d-why",children:[e.jsx("strong",{children:"⚡ Why we matched you:"})," Priya has defended 80+ criminal cases across Hyderabad courts, is fluent in Telugu, and has strong precedents in IPC sections relevant to your case."]}),e.jsxs("div",{className:"d-meta",children:[e.jsx("span",{children:"⭐ 4.8 rating"}),e.jsx("span",{children:"🕐 Responds in 1 hr"}),e.jsx("span",{children:"₹500 / 30 min"})]}),e.jsxs("div",{className:"d-ctas",children:[e.jsx("button",{className:"d-mc-p",children:"Connect Now"}),e.jsx("button",{className:"d-mc-s",children:"View Profile"})]})]})})]}),e.jsxs("section",{className:`d-scene${s===4?" d-active":""}`,children:[e.jsx("div",{className:"d-f5-item",children:e.jsx("div",{className:"d-final-badge",children:"✦  Start free today"})}),e.jsxs("h2",{className:"d-final-h d-f5-item",children:[e.jsx("span",{className:"l1",children:"Your advocate is waiting."}),e.jsx("span",{className:"l2",children:"Built for Telangana & AP Courts"})]}),e.jsxs("p",{className:"d-sub d-f5-item",style:{maxWidth:480},children:["Post your case. Get AI-matched in minutes.",e.jsx("br",{}),e.jsx("strong",{style:{color:"#10b981"},children:"First match consultation is free — no credit card required."})]}),e.jsxs("div",{className:"d-btns d-f5-item",children:[e.jsx("button",{className:"d-btn-p",onClick:()=>window.location.href="/register",children:"Get Started Free →"}),e.jsx("button",{className:"d-btn-o",onClick:S,children:"▶  Replay Demo"})]}),e.jsx("p",{className:"d-final-promise d-f5-item",children:"Verified advocates · Anonymous posting · 100% free to start"})]}),e.jsxs("div",{id:"demo-controls",children:[e.jsx("div",{style:{display:"flex",gap:".45rem",alignItems:"center"},children:l.map((a,t)=>e.jsx("div",{className:`d-dot${s===t?" d-active-dot":s>t?" d-done":""}`,onClick:()=>E(t),title:l[t].name},t))}),e.jsxs("button",{id:"demo-play-btn",onClick:$,children:[b?e.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"currentColor",children:[e.jsx("rect",{x:"6",y:"4",width:"4",height:"16"}),e.jsx("rect",{x:"14",y:"4",width:"4",height:"16"})]}):e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M8 5v14l11-7z"})}),Y]}),e.jsx("div",{id:"demo-scene-lbl",children:s>=0?`Scene ${s+1} of ${l.length} — ${l[s]?.name}`:"Scene 1 of 5"})]})]})}export{H as default};
